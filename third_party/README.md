...
- `sources/`: corresponding source archives required for redistributed copyleft components.
...
The Jugg repository license applies only to Jugg-owned code. Third-party components remain governed by their respective licenses. The included source archives are provided with the same distribution instead of relying on a later written source offer.
