...
- [Latest develop nightly build / develop 最新 Nightly 构建](https://github.com/sickworm/jugg/releases/download/nightly-develop/jugg-nightly-develop.zip)（develop 有新 commit 时自动构建，可能不稳定）
