...
import com.sickworm.intellij.aidp.compiler.BaseCompileContext
import com.sickworm.intellij.aidp.compiler.ICompileContext
import com.sickworm.intellij.aidp.compiler.ModuleInfo
import com.sickworm.intellij.aidp.getAndroidSdkRootDir
import com.sickworm.intellij.aidp.guessModuleDirAdv
import com.sickworm.intellij.aidp.relativePath
...
class CompileContextManager(
    ...
    val buildDir = File("$projectDir/build/aidp/build/")
