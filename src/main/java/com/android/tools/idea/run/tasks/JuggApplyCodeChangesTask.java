...
import com.android.tools.deployer.JuggDeployer;
...
public class JuggApplyCodeChangesTask extends JuggAbstractDeployTask {
     ...
     * @param fallback
     */
    public JuggApplyCodeChangesTask(@NotNull Project project,
    ...
    @Override
    protected JuggDeployer.Result perform(IDevice device, JuggDeployer deployer, String applicationId, List<File> files, JuggDeployData data) throws DeployerException {
