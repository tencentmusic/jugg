...
class KotlinCompileTest {
    ...
    fun cliCompile() {
        ...
        val command = "D:\\Java\\jdk1.8.0_77\\bin\\java.exe -Xmx256M -Xms32M -noverify -cp D:\\JETBRA~1\\INTELL~1.2\\plugins\\Kotlin\\kotlinc\\bin\\..\\lib\\kotlin-preloader.jar     org.jetbrains.kotlin.preloading.Preloader -cp D:\\JETBRA~1\\INTELL~1.2\\plugins\\Kotlin\\kotlinc\\bin\\..\\lib\\kotlin-compiler.jar      org.jetbrains.kotlin.cli.jvm.K2JVMCompiler  ${File(file).absolutePath} -d $classesBuildDir"
        Runtime.getRuntime().exec(command)
    }

    private val resultTask = CompileTask.singleFile("$assetsKotlinDir/com/sickworm/intellij/aidp/test/Result.kt", classesBuildDir)
    @Test
    fun kotlinCompile() {
