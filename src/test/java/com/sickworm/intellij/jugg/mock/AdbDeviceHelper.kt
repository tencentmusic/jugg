...
class AdbDeviceHelper {
    ...
    fun waitingForDeviceOfLaunchedApp(exceptPackageName: String, maxWaitingMills: Int = 60000): IDevice? {
        ...
        while (remainWaitingMills > 0) {
            ...
            if (pid > 0) {
                println("waitingForLaunchedApp read $exceptPackageName pid from am: $pid")
