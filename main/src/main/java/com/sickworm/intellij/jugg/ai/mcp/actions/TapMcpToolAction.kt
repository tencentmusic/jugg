...
class TapMcpToolAction : McpToolAction {
    ...
    private fun buildNotFoundCandidateDesc(
        candidates: List<com.sickworm.intellij.jugg.ai.mcp.viewhierarchy.MatchCandidate>,
    ...
    private fun buildNotFoundCandidateSummary(
        candidate: com.sickworm.intellij.jugg.ai.mcp.viewhierarchy.MatchCandidate,
        selectorContext: ElementSelectorContext,
    ): String? {
