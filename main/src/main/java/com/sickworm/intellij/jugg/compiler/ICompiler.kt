...
/**
 * CompileTask is the execution unit of one compile batch (input files, output directory, cancel state, and progress callbacks).
 */
class CompileTask(
...
/**
 * CompileFile carries type, file, baseDir, and module.
 */
data class CompileFile(
    ...
    /**
     * Type enumerates source/input artifact types accepted by compile stages.
     */
    enum class Type {
        Java,
        Kotlin,
...
/**
 * CompileOutput carries type, file, baseDir, and apkPath.
 */
data class CompileOutput(
    ...
    /**
     * Type enumerates output artifact categories produced by compile stages.
     */
    enum class Type {
        Class,
...
/**
 * CompileResult carries task, details, and outputs.
 */
...
/**
 * CompileError carries file and errors.
 */
...
/**
 * ICompiler defines the lifecycle of one compiler stage: file consumption, warm-up, compile execution, and disposal.
 */
...
/**
 * DesugarInfo carries allInterfacesWithDefaultMethod, coreLibraryRewriteClassMap, isNeedRewriteCoreLibrary, and desugaredLibraryConfiguration.
 */
