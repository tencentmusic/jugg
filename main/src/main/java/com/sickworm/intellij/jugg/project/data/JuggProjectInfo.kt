...
data class ExternalBuildInfo(
    ...
    val isSupported: Boolean
        get() = taskPath != null && outputDir != null && unsupportedReason == null
}
...
data class ModuleInfo(
    ...
    val externalBuildInfos: List<ExternalBuildInfo> = emptyList(),
) {
...
data class ModuleBuildPathInfo(
    ...
    private val builtInKotlinClassPath
        get() = File(
            buildDir,
    ...
    /** Kotlin class path selected from the active AGP output layout. */
    val kotlinClassPath get() = kotlinClassPathCandidates.newestFile() ?: legacyKotlinClassPath
    ...
    val composeResourceGeneratedSourcePath get() = File(generatedSourcePath, "compose/resourceGenerator/kotlin")
