...
class CompileContextManager(
    ...
    fun updateCustomClasspath(moduleCustomConfigs: List<ModuleCustomConfig>) {
        ...
        val sourceProjectInfo = baseProjectInfo ?: projectModelSource.load(ProjectModelLoadReason.INITIALIZE, currentBuildTarget()).projectInfo ?: error("Project model is unavailable")
