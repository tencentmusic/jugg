...
public object Res {
  ...
  public suspend fun readBytes(path: String): ByteArray =
      readResourceBytes("composeResources/com.sickworm.jugg.demo.kmp.generated.resources/" + path)
  ...
  public fun getUri(path: String): String =
      getResourceUri("composeResources/com.sickworm.jugg.demo.kmp.generated.resources/" + path)
