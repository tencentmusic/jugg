...
| Case | 期望 |
|------|------|
| HOOK-1 | 使用 Agent 文件编辑能力修改隔离 Android 源码文件后，edit hook 给软提醒 |
...
- 任一 hook 没有被真实 Agent 动作触发，或报告缺少反馈原文，对应项为 `FAIL`。
