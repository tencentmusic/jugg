...
| 入口 | 文件路径 | 说明 |
|------|----------|------|
| IDEA 项目协调 | `idea/src/main/java/com/sickworm/intellij/jugg/JuggManager.kt` | 接收 Sync/Run/UI/MCP 事件，管理配置刷新、历史恢复、Compile Context 关联、IDEA monitor 接线、Control Panel 和 dispose；文件变化处理已委托共享 `FileChangeManager` |
