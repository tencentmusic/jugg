...
| compiler | ConstRefEngine, ConstRefAnalyzer, ConstRefChangeTracker, ConstRefImpactResolver | compiler/constref | 编译期常量定义/引用分析；按“真实变更常量 key”定位受影响源码；全局共享缓存（repo/worktree 复用）与过期清理 | 稳定 | 2026-02-28 |
