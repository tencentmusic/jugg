...
- `Install Jugg Skills` 由 `InstallJuggSkillsDialog` 触发 `JuggSkillInstaller`，会安装内置 skills、CLI、hooks，并导出 `~/.jugg/skills/install/agent_setup.md`；hook 细节以 `docs/skills` 和 `08_cli_tools_list.md` 为准。
