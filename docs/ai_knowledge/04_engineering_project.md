...
jugg CLI 发现目标项目没有 owner
  ...
  -> McpLocalServer
     ...
     init / compile / deploy / gradle-build / status / restart / devices 按 projectDir 路由到项目 Runtime
```
