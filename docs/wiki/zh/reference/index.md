...
参考页用于快速确认 Jugg 的稳定名词、命令参数、工具契约、配置含义、日志位置和运行边界。它不是教程，也不解释深层机制；如果你要按步骤完成一次运行、调试或查看常见问题，优先阅读使用指南和常见问题页。
...
> [!TIP]
> 参考页面会尽量保持简短。涉及完整工作流时，页面会链接到对应指南、能力页或常见问题页，而不是重复展开所有步骤。
