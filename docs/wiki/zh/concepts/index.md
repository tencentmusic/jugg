...
| 你想了解什么 | 建议阅读 |
|---|---|
| 一次 Run 如何完成决策、编译、部署和状态提交 | [Jugg 工作原理](./how-jugg-works.md)、[编译流水线](./compile-pipeline.md)、[重试、重装与 Gradle 构建](./fallback-and-limits.md) |
...
4. [重试、重装与 Gradle 构建](./fallback-and-limits.md)：理解一次 Run 怎样从局部恢复走到完整构建。
