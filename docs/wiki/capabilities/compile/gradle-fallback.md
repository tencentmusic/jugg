...
| Too many files or modules | Prompt or automatic fallback supported | Configuration determines whether confirmation is required (enabled by default; can disable confirmation in Running Panel to fall back directly) |
