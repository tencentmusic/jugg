...
| Change ordinary logic in an existing Hilt Android entry point | Supported | When existing Hilt generated artifacts are available, restores the entry-point transform before DEX generation and preserves injection; see [Annotation processors](./annotation-processors.md) |
