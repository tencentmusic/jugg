...
| DataBinding layout uses a BindingAdapter from a direct project dependency | Supported by reusing the dependency module's setter store | Mapper resolves the custom attribute and generates BindingImpl |
