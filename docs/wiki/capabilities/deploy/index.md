...
| [Custom APK sign script](./custom-apk-sign-script.md) | Supports replacing the default keystore signing of a rewritten APK with a project script | Supports platform certificates, vendor keys, and server-side signing flows |
