...
2. 更新 `docs/task/2026-07/kmp_compose_incremental_compile_support_plan.md` 与 `docs/task/2026-07/2026-07-25-compose-1.7.3-incremental-resource-implementation-plan.md`：删除“通过 property 启用”的描述和带 property 的命令。
