...
## 1. 背景
- 目标：复用 `docs/task/CONST_REF_ENGINE_FREEZE_FIX_PLAN_2026-03-06.md` 中“性能基准测试”思路，对外部工程 `JOOX_Android_3` 进行首次与增量两轮评估。
...
## 4. 产物位置
- `docs/task/joox_constref_benchmark_2026-03-06/benchmark_first_scan.json`
- `docs/task/joox_constref_benchmark_2026-03-06/benchmark_incremental_scan.json`
- `docs/task/joox_constref_benchmark_2026-03-06/benchmark_compare.json`
- `docs/task/joox_constref_benchmark_2026-03-06/REPORT.md`
- `docs/task/joox_constref_benchmark_2026-03-06/ANALYSIS_REPORT.md`
