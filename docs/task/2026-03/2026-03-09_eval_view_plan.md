...
> 日期：2026-03-09
> 状态：草稿
> 关联文档：`2026-03-09_mcp_to_ui_test_strategy.md`、`layout_verify_eval_plan.md`
...
| 更新 `layout_verify_eval_plan.md` 测试计划 | `docs/task/2026-03/` | 小 | 重新分类用例：属性 → eval_view，关系 → layout_verify |
